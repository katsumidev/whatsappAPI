    ...
    return (
        <>
            ...
            <Container>
                <FormLeft>
                    <form>
                        ...
                        <input type="text" placeholder="Informe o nome da companhia"/> <br />
            ...
            <Audience>
                ...
                <p>Aviso! Deletar todos os contatos da audiência e estatísticas de interações.</p>
            </Audience>
            <Audience>
                <span className="span">Zerar companhia</span>
                <p>Aviso! Restaurar companhia ao estado original, completamente vazia, sem fluxos, sem audiência... nada.</p>
            </Audience>
        </>
    );
}
