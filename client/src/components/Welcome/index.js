    ...
    <>
      ...
      <Container>
        <LeftContainer>
          ...
          <label htmlFor="respostas-do-patrao" className="label">
            Respostas do patrão:
          </label>
          <select name="welcome" id="welcome">
            <option value="rembolso">Quer Rembolsar / Trocar</option>
          ...
          <label htmlFor="fluxo-padrão-para-midia">
        ...
        <RightContainer>
          ...
          <p>
            Segunda-feira: <main>19:59 - 19:59</main>{" "}
          </p>
          <p>
            terça-feira: <main>19:59 - 19:5</main> 9
          </p>
          <p>
            quarta-feira: <main>19:59 - 19:59</main>{" "}
          </p>
          <p>
            quinta-feira: <main>19:59 - 19:59</main>{" "}
          </p>
          <p>
            sexta-feira: <main>19:59 - 19:59</main>
          </p>
          <p>
            sabado-feira: <main>19:59 - 19:59</main>
          </p>
          <p>
            domingo-feira: <main></main>{" "}
          </p>
          <p>
            domingo-feira: <main></main>
          </p>
